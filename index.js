...
function insertData(){
    var userInfo = {
        clinicName:$("#clinicName").val(), date:$("#date").val(),
        adress:$("#adressadress").val(),
        version:$("#version").val(),
